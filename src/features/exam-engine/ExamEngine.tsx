...
export const ExamEngine: React.FC = () => {
  ...
  if (examState === 'intro') {
    return (
      <ExamIntroView
        ...
        mockExamsList={mockExamsList}
        subjectAssessmentBlueprints={subjectAssessmentBlueprints}
        ...
        onReviewPastResult={handleReviewPastResult}
      />
    );
  }

  // 2. Màn hình làm bài thi (Testing)
  if (examState === 'testing') {
    return (
      <ExamTakingView
        ...
        proofImagesByQuestion={proofImagesByQuestion}
        timeLeft={timeLeft}
        isSubmittingExam={isSubmittingExam}
        examSubmitError={examSubmitError}
        onOptionSelect={handleOptionSelect}
        onInputChange={handleInputChange}
        onFinalAnswerChange={handleFinalAnswerChange}
        onProofImagesChange={handleProofImagesChange}
  ...
  // 3. Màn hình báo cáo kết quả (Result)
  if (examState === 'result' && examResult) {
    return (
      <ExamResultView
        ...
        subjectQuestionTypes={subjectQuestionTypes}
