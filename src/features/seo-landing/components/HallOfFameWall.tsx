      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 text-left reveal-on-scroll">
        ...
        <div className="inline-flex items-center gap-3 p-3 px-4 rounded-2xl island-nav self-start md:self-auto shrink-0 shadow-sm">
          <div className="flex -space-x-2">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-blue-500 text-white text-xs font-black ring-2 ring-background">
              A
            </span>
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-amber-500 text-white text-xs font-black ring-2 ring-background">
              K
            </span>
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-emerald-500 text-white text-xs font-black ring-2 ring-background">
              V
            </span>
          </div>
          <div>
        ...
        {SUCCESS_STORIES.map(item => (
          ...
          >
            ...
            <div className="mt-6 pt-4 border-t border-border/80 flex items-center justify-between text-[11px]">
              <span className="font-black text-emerald-600 dark:text-emerald-400 px-2.5 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20">
                {item.badge}
              </span>
